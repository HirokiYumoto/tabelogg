            ...
            @auth
                <div class="flex items-center gap-3">
                    ...
                    @if(Auth::user()->role_id === 3)
                        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-1.5 bg-red-50 hover:bg-red-100 text-red-600 hover:text-red-700 px-3 py-1.5 rounded-full transition duration-300 shadow-sm border border-red-200 hover:border-red-300">
                            ...
                            <span class="text-xs sm:text-sm font-bold whitespace-nowrap">管理者</span>
                        </a>
                    @endif
