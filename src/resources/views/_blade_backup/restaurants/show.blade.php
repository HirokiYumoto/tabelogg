            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div id="myTabContent" class="p-6 lg:p-10 min-h-[400px]">
                    ...
                    <div class="js-tab-content hidden" id="reviews" role="tabpanel">
                        ...
                        {{-- レビューの要旨 --}}
                        @if($restaurant->review_summary)
                            @php $summary = $restaurant->review_summary; @endphp
                            <div class="bg-orange-50 border border-orange-200 rounded-lg p-6 mb-8">
                                <h3 class="font-bold text-gray-800 mb-3 flex items-center gap-2">
                                    <span>📊</span>
                                    <span>レビューの要旨（{{ $summary['review_count'] }}件のレビューに基づく）</span>
                                </h3>
                                <p class="text-gray-700 leading-relaxed mb-4">{{ $summary['text'] }}</p>

                                @if(!empty($summary['good_points']))
                                    <div class="mb-3">
                                        <p class="font-bold text-gray-700 mb-1">👍 良い点</p>
                                        <ul class="text-gray-600 text-sm space-y-1 ml-1">
                                            @foreach($summary['good_points'] as $point)
                                                <li>・{{ $point }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                                ...
                                @if(!empty($summary['bad_points']))
                                    <div>
                                        <p class="font-bold text-gray-700 mb-1">💡 気になる点</p>
                                        <ul class="text-gray-600 text-sm space-y-1 ml-1">
                                            @foreach($summary['bad_points'] as $point)
                                                <li>・{{ $point }}</li>
                                            @endforeach
                                        </ul>
                                    </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="lg:col-span-1">
                                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 sticky top-4">
                                    ...
                                    @auth
                                        @if($hasReviewed)
                                            <p class="text-sm text-gray-500">この店舗にはすでにレビューを投稿済みです。</p>
                                        @else
                                            @if($errors->any())
                                    ...
                                    <div class="wz-step hidden" data-step="5">
                                        ...
                                        <div class="bg-orange-50 border border-orange-200 rounded-lg p-6 mb-6">
                                            <dl class="space-y-3 text-sm">
                                                ...
                                                <div class="flex justify-between"><dt class="text-gray-500">滞在可能時間（目安）</dt><dd class="font-bold" id="wz-cf-stay"></dd></div>
                                            </dl>
                                        </div>
    ...
    <script>
        ...
        (function() {
            ...
            const state = {
                ...
                seatCategory: null, seatLabel: null, stayMinutes: null,
            ...
            async function loadSeats() {
                ...
                try {
                    ...
                    state.stayMinutes = data.stay_minutes || null;
            ...
            function showConfirmation() {
                ...
                document.getElementById('wz-cf-stay').textContent = state.stayMinutes ? state.stayMinutes + '分' : '—';
